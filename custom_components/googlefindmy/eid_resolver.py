    ...
    async def _refresh_cache(self) -> None:  # noqa: PLR0912, PLR0915
        ...
        for identity in identities:
            ...
            if rotation_ts is not None:
                elapsed = now_unix - rotation_ts
                current_rotation_count = elapsed // ROTATION_PERIOD
                for step in (-1, 0, 1):
                    target_rotation = current_rotation_count + step
                    window_ts = rotation_ts + (target_rotation * ROTATION_PERIOD)
