#!/usr/bin/env python3
"""Summarize cached wheelhouse contents and manifest coverage.

This helper lists wheel metadata grouped by distribution so operators can
quickly confirm that the cached Home Assistant SSoT wheels satisfy the
expected manifest before kicking off lengthy installs.
"""
