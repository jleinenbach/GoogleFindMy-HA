...
class GoogleFindMyCoordinator(DataUpdateCoordinator):
    ...
    def __init__(self, hass: HomeAssistant, secrets_data: dict, tracked_devices: list = None, location_poll_interval: int = 300, device_poll_delay: int = 5, min_poll_interval: int = 120) -> None:
        """Initialize."""
